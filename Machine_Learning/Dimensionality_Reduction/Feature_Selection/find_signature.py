...
print(accuracy)
print('Importance of the most important feature:',max(clf.feature_importances_))
print('Number of most important feature:',list(clf.feature_importances_).index(max(clf.feature_importances_)))
print(list(clf.feature_importances_)[-1])
